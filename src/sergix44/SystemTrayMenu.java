...
public class SystemTrayMenu {
    ...
    public SystemTrayMenu(final String ip,final String id, final String pass) throws AWTException, IOException, UnsupportedAudioFileException, LineUnavailableException{
        try {
        ...
        if (SystemTray.isSupported()) {
            ...
            final TrayIcon trayIcon = new TrayIcon(ImageIO.read(getClass().getResource("icona.jpg")),"ownPuush");
            ...
            clip.open(AudioSystem.getAudioInputStream(getClass().getResource("complete.wav")));
            ...
            catturaArea.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    try {
                        ...
                        s.send(id,pass);
                        trayIcon.displayMessage("Puush Caricato!", s.getLink(),TrayIcon.MessageType.INFO);
    ...
    public static void main(String[] args) throws InterruptedException, InvocationTargetException, AWTException, IOException, UnsupportedAudioFileException, LineUnavailableException {
