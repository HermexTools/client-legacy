...
public class PartialScreen extends JPanel {
    ...
    public Rectangle getSelection(){
        if(fromClickPoint.x+fromClickPoint.y<toClickPoint.x+toClickPoint.y)
            return new Rectangle(fromClickPoint.x+1,fromClickPoint.y+1,toClickPoint.x-fromClickPoint.x-1,toClickPoint.y-fromClickPoint.y-1);
        else
            return new Rectangle(toClickPoint.x+1,toClickPoint.y+1,fromClickPoint.x-toClickPoint.x-1,fromClickPoint.y-toClickPoint.y-1);
    }
